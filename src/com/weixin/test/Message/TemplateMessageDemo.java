...
public class TemplateMessageDemo {
...
//					+ "\"text\":{\"content\":\"Hello World回复场景模拟\"}}";
			String content = "{\"touser\":\"oPP1dwT7HxpEtvdbO3EpRbmDemHg\",\"template_id\":\"nchBgpWs4C7wQhJGCA_WA21eHGOKJRqTkkt0EOlKjOA\",\"url\":\"http://weixin.qq.com/download\",\"topcolor\":\"#FF0000\",\"data\":{\"first\":{\"value\":\"您好，您有一个新的会议。\",\"color\":\"#173177\"},\"keyword1\":{\"value\":\"思科交流会\",\"color\":\"#173177\"},\"keyword2\":{\"value\":\"2017年8月1日\",\"color\":\"#173177\"}}}";
			// 直接引用远程的wsdl文件
			// 以下都是套路
			 ...
			 */
			call.setOperationName(new QName("http://wxservice.shdt.com/", "templateMessage"));// WSDL里面描述的接口名称
